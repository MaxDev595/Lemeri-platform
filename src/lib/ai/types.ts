...
export type GenerateInput = { employeeName: string; role: string; goal: string; tone: string; instructions?: string; handoffRules?: Record<string,unknown>; messages: AIMessage[]; knowledge: KnowledgeMatch[]; allowedActionKeys?: string[]; context?: string };
