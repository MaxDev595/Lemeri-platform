...
export const ChannelGlyph = {
  ...
  WHATSAPP: (p: GlyphProps) => (
    <svg {...base} {...p}>
      <path d="M3.6 20.4 4.9 16.6A8.6 8.6 0 1 1 7.6 19.2Z" />
      <path strokeWidth={1.5} d="M9.1 8.2c.3-.3.8-.3 1.1 0l1 1.3c.2.3.2.7 0 1l-.5.6c.5 1.1 1.3 1.9 2.4 2.4l.6-.5c.3-.2.7-.2 1 0l1.3 1c.3.3.3.8 0 1.1l-.6.6c-.6.6-1.5.8-2.3.4a8.6 8.6 0 0 1-4.1-4.1c-.4-.8-.2-1.7.4-2.3Z" />
    </svg>
  ),
  EMAIL: (p: GlyphProps) => (
    <svg {...base} {...p}>
